...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    I've made a couple of projects in that language. I also do app development. Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/AjayRajNegi" target="_blank">Github</a>!`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://my-resume-topaz-five.vercel.app/" target="_blank">Check it out?</a>. I haven't updated it in long time though😬
  Contact me at ajayrajnegi111@gmail.com if you have any interesting job opportunities!`,
  ...
  library: `I like reading philosophical books,`,
